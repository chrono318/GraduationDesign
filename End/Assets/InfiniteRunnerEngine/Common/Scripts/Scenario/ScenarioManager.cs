...
namespace MoreMountains.InfiniteRunnerEngine
{
	...
	public class ScenarioManager : MonoBehaviour 
	{
		...
		[Information("Here you can set the frequency (in seconds) at which the scenario will be evaluated. Depending on how many events are in your scenario, this can be heavy on performance, so you might want to space the evaluations more.",MoreMountains.Tools.InformationAttribute.InformationType.Info,false)]
		public float EvaluationFrequency=1;
		[Information("You can also choose to use the MMEventManager class to propagate events outside of this class.",MoreMountains.Tools.InformationAttribute.InformationType.Info,false)]
