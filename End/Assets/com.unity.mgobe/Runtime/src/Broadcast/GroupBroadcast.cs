...
namespace com.unity.mgobe.Runtime.src.Broadcast
{
    public class GroupBroadcast
    {
        ...
        // 队组内玩家自定义属性变化广播
        public void OnChangeGroupPlayerProfile(BroadcastEvent eve) {
            var groupInfo = ((ChangeGroupPlayerProfileBst)eve.Data).GroupInfo;
            this.SaveAndInvoke (groupInfo, () => this._group?.OnChangeGroupPlayerProfile(eve));
        }
