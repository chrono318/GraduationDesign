...
namespace com.unity.mgobe.src.Group
{
    public class Group: BaseNetUtil
    {
        ...
        private readonly ServerSendClientBstWrap2Type _changeGroupPlayerProfileBstType = ServerSendClientBstWrap2Type.EPushTypeModifyGroupPlayerProfile;
        ...
        public Group(BstCallbacks bstCallbacks) : base(bstCallbacks)
        {
            ...
            this.SetBroadcastHandler(this._changeGroupPlayerProfileBstType, this.OnChangeGroupPlayerProfile);
        ...
        {
            const int subcmd = (int)ClientSendServerReqWrap2Cmd.ECmdCreateGroupReq;
        ...
        {
            const int subcmd = (int)ClientSendServerReqWrap2Cmd.ECmdJoinGroupReq;
        ...
        {
            const int subcmd = (int)ClientSendServerReqWrap2Cmd.ECmdQuitGroupReq;
        ...
        {
            const int subcmd = (int)ClientSendServerReqWrap2Cmd.ECmdDismissGroupReq;
        ...
        {
            const int subcmd = (int)ClientSendServerReqWrap2Cmd.ECmdChangeGroupPropertiesReq;
        ...
        {
            const int subcmd = (int)ClientSendServerReqWrap2Cmd.ECmdRemoveGroupMemberReq;
        ...
        {
            const int subcmd = (int)ClientSendServerReqWrap2Cmd.ECmdGetGroupDetailReq;
        ...
        {
            const int subcmd = (int)ClientSendServerReqWrap2Cmd.ECmdGetGroupListReq;
        ...
        {
            const int subcmd = (int)ClientSendServerReqWrap2Cmd.ECmdChangeGroupPlayerStateReq;
        ...
        public string ChangeGroupPlayerProfile(ChangeGroupPlayerProfileReq para, Action<ResponseEvent> callback)
        {
            const int subcmd = (int)ClientSendServerReqWrap2Cmd.ECmdChangeGroupPlayerProfile;
            var response = new NetResponseCallback(ChangeGroupPlayerProfileResponse);
            var seq = this.Send(para, subcmd, response, callback);
            Debugger.Log("ChangeGroupPlayerProfile_Para {0} {1}", para, seq);
            return seq;
        }
        
        public string SendToGroupClient(SendToGroupClientReq para, Action<ResponseEvent> callback)
        {
            const int subcmd = (int)ClientSendServerReqWrap2Cmd.ECmdGroupChatReq;
        ...
        private void ChangeGroupPlayerProfileResponse(bool send, DecodeRspResult res, Action<ResponseEvent> callback)
        {
            var rspWrap1 = res.RspWrap1;
            var eve = new ResponseEvent(rspWrap1.ErrCode, rspWrap1.ErrMsg, rspWrap1.Seq, res.Body);
            Debugger.Log("ChangeGroupPlayerProfileResponse {0}", eve);
            callback?.Invoke(eve);
            return;
        }
        ...
        private void OnChangeGroupPlayerProfile(DecodeBstResult bst, string seq)
        {
            var eve = new BroadcastEvent(bst.Body, seq);
            Debugger.Log("OnChangeGroupPlayerProfile {0}", eve);
            this.bstCallbacks.Group.OnChangeGroupPlayerProfile(eve);
        }
