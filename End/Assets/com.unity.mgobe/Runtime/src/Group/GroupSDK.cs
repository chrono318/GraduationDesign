...
namespace com.unity.mgobe
{
    public class Group: GroupBroadcastHandler
    {
        ...
        public void ChangeGroupPlayerProfile(ChangeGroupPlayerProfilePara para, Action<ResponseEvent> callback)
        {
            ChangeGroupPlayerProfileReq req = new ChangeGroupPlayerProfileReq
            {
                GroupId = this.GroupInfo.Id,
            ...
            Action<ResponseEvent> cb = eve =>
            {
                this.GroupUtil.SaveGroupInfo(eve, ((ChangeGroupPlayerProfileRsp)eve.Data)?.GroupInfo);
                callback?.Invoke(eve);
            };
            
            Core.Group.ChangeGroupPlayerProfile(req, cb);
        }
